...
const AGENTS = [
  {
    ...
    desc: "Autonomously browses the web, extracts structured data, synthesises reports from multiple sources with citations.",
  ...
  },
  {
    ...
    desc: "Connects to your databases, runs queries, visualises trends, and surfaces anomalies before they become problems.",
